...
pub struct FareMedia {
    ...
    #[serde(rename = "fareMediaName", skip_serializing_if = "Option::is_none")]
    pub fare_media_name: Option<String>,
    /// The type of fare media.
    #[serde(rename = "fareMediaType")]
    pub fare_media_type: models::FareMediaType,
}

impl FareMedia {
    pub fn new(fare_media_type: models::FareMediaType) -> FareMedia {
        FareMedia {
