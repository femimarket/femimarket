...
/// RefreshItineraryPostBody : Body for the `refreshItineraryPost` endpoint. Carries only the structured itinerary identifier; all routing parameters are passed as query parameters (same as the `refreshItinerary` GET endpoint). 
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct RefreshItineraryPostBody {
    #[serde(rename = "id")]
    pub id: Box<models::ItineraryId>,
}

impl RefreshItineraryPostBody {
    ...
    pub fn new(id: models::ItineraryId) -> RefreshItineraryPostBody {
