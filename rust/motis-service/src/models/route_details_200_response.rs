...
pub struct RouteDetails200Response {
    #[serde(rename = "routes")]
...
impl RouteDetails200Response {
    pub fn new(routes: Vec<models::RouteInfo>, polylines: Vec<models::RoutePolyline>, stops: Vec<models::Place>, zoom_filtered: bool) -> RouteDetails200Response {
