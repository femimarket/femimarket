...
pub struct Initial200Response {
    ...
    pub server_config: Box<models::ServerConfig>,
}

impl Initial200Response {
    pub fn new(lat: f64, lon: f64, zoom: f64, server_config: models::ServerConfig) -> Initial200Response {
        Initial200Response {
            lat,
            lon,
            zoom,
            server_config: Box::new(server_config),
        }
    }
}
