...
/// TimeRange : A time interval. The interval is considered active at time t if t is greater than or equal to the start time and less than the end time. 
...
impl TimeRange {
    ...
    pub fn new(start: chrono::DateTime<chrono::FixedOffset>, end: chrono::DateTime<chrono::FixedOffset>) -> TimeRange {
        TimeRange {
            start,
            end,
        }
