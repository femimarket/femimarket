...
/// Category : not available for GTFS datasets by default For NeTEx it contains information about the vehicle category, e.g. IC/InterCity 
...
impl Category {
    ...
    pub fn new(id: String, name: String, short_name: String) -> Category {
        Category {
            id,
            name,
            short_name,
