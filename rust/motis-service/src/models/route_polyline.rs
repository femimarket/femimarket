...
/// RoutePolyline : Shared polyline used by one or more route segments
...
pub struct RoutePolyline {
    ...
    #[serde(rename = "routeIndexes")]
    pub route_indexes: Vec<i32>,
}

impl RoutePolyline {
    /// Shared polyline used by one or more route segments
    pub fn new(polyline: models::EncodedPolyline, colors: Vec<String>, route_indexes: Vec<i32>) -> RoutePolyline {
        RoutePolyline {
