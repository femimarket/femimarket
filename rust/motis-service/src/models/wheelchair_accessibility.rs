...
impl std::fmt::Display for WheelchairAccessibility {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            Self::Accessible => write!(f, "ACCESSIBLE"),
            Self::NotAccessible => write!(f, "NOT_ACCESSIBLE"),
        }
    }
}

impl Default for WheelchairAccessibility {
    fn default() -> WheelchairAccessibility {
        Self::Accessible
    }
}
